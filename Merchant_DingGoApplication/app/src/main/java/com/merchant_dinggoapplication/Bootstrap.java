...
public class Bootstrap {
    ...
    public void initializeEntity() {
        ...
        Bitmap coverImage_four_chicken = BitmapFactory.decodeResource(mContext.getResources(),
                R.mipmap.coverfourseasonschicken);
