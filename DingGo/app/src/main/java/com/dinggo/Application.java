...
import com.dinggo.managers.PreferencesManager;
import com.dinggo.utilities.Config;
import com.dinggo.utilities.DAOUtil;
    ...
    public void onCreate() {
        ...
        */
        ...
        CalligraphyConfig.initDefault(new CalligraphyConfig.Builder()
                        ...
                        .setFontAttrId(com.dinggo.R.attr.fontPath)
                        .build()
        );
